...
#+begin_src emacs-lisp
    ...
    ;; Small function to open files in a new frame from dired.
        ...
        (eval-after-load "dired"
          '(define-key dired-mode-map "F" 'dired-find-fiile-other-frame))
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (add-hook 'org-mode-hook '(lambda ()
                                ...
                                (visual-line-mode)
                                (org-indent-mode))))
  ;; start with inline images turned on
  (setq org-startup-with-inline-images t)
  (setq org-todo-keywords
      '((setqence "TODO" "IN-PROGRESS" "WAITING" "DONE")))
#+END_SRC
** Org languages
#+begin_src emacs-lisp
  (use-package ob-go
