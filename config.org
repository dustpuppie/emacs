...
#+Begin_src emacs-lisp
	  ...
	  :url "https://github.com/emacsorphange/anzu"
	  :ensure t
	...
	(message "Anzu completed")
	  ...
	  (leaf vertico-posframe
	    ...
	    (vertico-posframe-parameters
		 ...
		 (right-fringe . 8)))
	    :custom-face
	    (vertico-postframe-border . ' ((t (:background "#323445")))))
	(message "Vertico completed")
	  (leaf consult
	  ...
	  (leaf consult-custom
	    ...
	    (defun consult-find-doc ()
	      "Search the org files in the private document directory"
	      (interactive)
	  ...
	  (leaf marginalia
	    :doc "Explain the details of the consult candidates"
...
#+Begin_src emacs-lisp
    (leaf pdf-tools
      :doc "open and view pdf files directly in emacs"
